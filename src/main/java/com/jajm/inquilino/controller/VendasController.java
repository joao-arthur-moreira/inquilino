...
import com.jajm.inquilino.controller.validator.VendaValidator;
import com.jajm.inquilino.dto.VendaMes;
import com.jajm.inquilino.dto.VendaOrigem;
import com.jajm.inquilino.mail.Mailer;
import com.jajm.inquilino.model.Imovel;
import com.jajm.inquilino.model.ItemVenda;
import com.jajm.inquilino.model.StatusVenda;
import com.jajm.inquilino.model.TipoPessoa;
...
import com.jajm.inquilino.repository.filter.VendaFilter;
import com.jajm.inquilino.security.UsuarioSistema;
import com.jajm.inquilino.service.CadastroVendaService;
...
public class VendasController {
	...
	public ModelAndView adicionarItem(Long codigoCerveja, String uuid) {
		Imovel imovel = imoveis.findOne(codigoCerveja);
		tabelaItens.adicionarItem(uuid, imovel, 1);
		return mvTabelaItensVenda(uuid);
	}
	
	@PutMapping("/item/{codigoCerveja}")
	public ModelAndView alterarQuantidadeItem(@PathVariable("codigoCerveja") Imovel imovel
			, Integer quantidade, String uuid) {
		tabelaItens.alterarQuantidadeItens(uuid, imovel, quantidade);
		return mvTabelaItensVenda(uuid);
	}
	
	@DeleteMapping("/item/{uuid}/{codigoCerveja}")
	public ModelAndView excluirItem(@PathVariable("codigoCerveja") Imovel imovel
			, @PathVariable String uuid) {
		tabelaItens.excluirItem(uuid, imovel);
		return mvTabelaItensVenda(uuid);
	}
