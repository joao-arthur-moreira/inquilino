...
@EnableJpaRepositories(basePackageClasses = Imoveis.class, enableDefaultTransactions = false)
...
public class JPAConfig {
	...
	public DataSource dataSource() {
		...
		return dataSourceLookup.getDataSource("jdbc/inquilino");
	}
	...
	public EntityManagerFactory entityManagerFactory(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter) {
		...
		factory.setPackagesToScan(Imovel.class.getPackage().getName());
